...
async function fetchTransactionTypes() {
  const response = await fetch('https://spendwise-backend-awir4h3fu-rider4585s-projects.vercel.app/api/getTransactionTypes');
  if (!response.ok) {
...
async function addTransaction(data) {
  if (navigator.onLine) {
    try {
      const response = await fetch('https://spendwise-backend-awir4h3fu-rider4585s-projects.vercel.app/api/addTransaction', {
        method: 'POST',
        headers: {
